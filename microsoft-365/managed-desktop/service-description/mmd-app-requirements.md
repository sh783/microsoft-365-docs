...
If an application requires a specific driver(s) to run it is considered a Restricted Application and requires an exception to be deployed to Microsoft Managed Desktop. 
